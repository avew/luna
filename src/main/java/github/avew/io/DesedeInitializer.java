...
public class DesedeInitializer {
    ...
    public static File decryptFile(File inputFile, File outputFile) throws InvalidKeyException, NoSuchAlgorithmException, DecoderException, InvalidKeySpecException, NoSuchPaddingException, InvalidAlgorithmParameterException, UnsupportedEncodingException, BadPaddingException, IllegalBlockSizeException {
        String algorithm = "DESede";
        String transformation = "DESede/CBC/PKCS5Padding";
        byte[] keyValue = "XsCTcq3LNFfNsAEj2anL4000".getBytes();
        DESedeKeySpec keySpec = new DESedeKeySpec(keyValue);
